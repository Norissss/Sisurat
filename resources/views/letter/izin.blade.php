...
<form action="/letter/add" method="POST" enctype="multipart/form-data">
    ...
    <div class="card-body">
        ...
        @endif
        <div class="form-group">
            <label>Format Surat Izin Perkuliahan di Jurusan Teknik Informatika bisa di download pada: <a href="https://docs.google.com/document/d/1hd-ciWI-GU0cWPPEIgsTO9ZEKrsLCLQA/edit?usp=sharing&ouid=107363389072124571561&rtpof=true&sd=true">https://docs.google.com/document/d/1hd-ciWI-GU0cWPPEIgsTO9ZEKrsLCLQA/edit?usp=sharing&ouid=107363389072124571561&rtpof=true&sd=true</a>
            </label>
        <div class="form-row">
        ...
        <div class="form-grup" id="upload-foto">
            <div class="mb-3">
                <label for="foto">Unggah Surat Bukti(Surat MC/ Surat Perintah Lembur/ Bukti izin lainnya) <b class="text-danger">*</b></label>
        ...
        <div class="form-grup" id="upload-foto1">
            <div class="mb-3">
                <label for="foto">Unggah bukti Persetujuan Dosen Wali <b class="text-danger">*</b></label>
        ...
        <div class="form-grup" id="upload-foto">
            <div class="mb-3">
                <label for="foto">Unggah Surat Izin yang sesuai Format TU <b class="text-danger">*</b></label>
    ...
    <div class="card-footer">
        ...
        <button type="reset" class="btn btn-danger float-right mr-2">Atur ulang</button>
    </div>
</form>
